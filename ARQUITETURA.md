...
* **Frequência Realista e Custo Zero**: O motor roda como uma thread leve em segundo plano no próprio servidor Rails (Puma), sem necessitar de VMs ou bancos adicionais. Os eventos são disparados a cada **15 a 30 segundos** para manter o dashboard dinamicamente atualizado de forma instantânea sem sobrecarregar a infraestrutura gratuita no Fly.io.
